...
public class Client {
  ...
  public static void main(String[] args) {
    ...
    // add Employees to it
    // make them Hourly or Salaried (Employee is abstract)
    dept.addEmployee(new HourlyEmployee("Jason", Date.valueOf("1990-08-24"), 30, 40));
    dept.addEmployee(new SalariedEmployee("Tina", Date.valueOf("2000-02-02"), 45000));
